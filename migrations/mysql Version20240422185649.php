...
final class Version20240422185649 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE SEQUENCE review_id_seq INCREMENT BY 1 MINVALUE 1 START WITH 1');
        $this->addSql('CREATE SEQUENCE tag_id_seq INCREMENT BY 1 MINVALUE 1 START WITH 1');
        $this->addSql('CREATE SEQUENCE user_id_seq INCREMENT BY 1 MINVALUE 1 START WITH 1');
        $this->addSql('CREATE SEQUENCE video_game_id_seq INCREMENT BY 1 MINVALUE 1 START WITH 1');
        ...
        $this->addSql('CREATE TABLE video_game (
            id INT NOT NULL,
            ...
            updated_at TIMESTAMP NULL COMMENT \'(DC2Type:datetime_immutable)\',
